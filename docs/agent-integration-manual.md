...
One investigation pass produces both an analysis and a feature list.
...
- `storeFeature` for ≥1 feature (name, description, confidence: 0.5|0.8|1.0). Zero features = failed Tier 2.
